...
#Configuration du bibliothèque d'authenetification
#fine django-guardian
...
LOGIN_REDIRECT_URL='home'  #<----------- Page sur laquelle rediriger en cas de connexion

LOGOUT_REDIRECT_URL=LOGIN_URL

MEDIA_URL='/media/'  # URL à partir duquel acceder aux images
MEDIA_ROOT=BASE_DIR.joinpath('media/')  # Repertoir local de stockage des images
